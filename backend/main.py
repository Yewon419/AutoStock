...
from api import users, market, strategies, trading, broker, dashboard, ai, bot_canvas, knowledge_sources
...
app.include_router(knowledge_sources.router, prefix="/api/v1")
